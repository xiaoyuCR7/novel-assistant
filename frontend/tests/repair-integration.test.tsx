...
it("refreshes only chat dependencies and connects feedback and confirmed rules", async () => {
  ...
  vi.stubGlobal("fetch", vi.fn((input: RequestInfo | URL, init?: RequestInit) => {
    ...
    if (url.endsWith("/settings/model")) data = { mode: "demo", base_url: "", model: "", has_api_key: false, external_consent: false };
    ...
    if (url.endsWith('/ai/jobs/preflight')) data = { required_input_tokens: 1000, token_budget: 12000,
      output_token_budget: 4096, context_capacity: 32768, effective_input_limit: 12000,
